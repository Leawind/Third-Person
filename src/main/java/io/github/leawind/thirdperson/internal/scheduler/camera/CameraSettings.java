...
import io.github.leawind.thirdperson.internal.scheduler.camera.CameraSmoothing;
import io.github.leawind.thirdperson.internal.scheduler.camera.ModeSmoothing;
...
public final class CameraSettings {
  ...
  public void updateModeSmoothing(
      CameraProfileSlot slot, UnaryOperator<ModeSmoothing> update) {
    Objects.requireNonNull(slot, "slot");
    Objects.requireNonNull(update, "update");
    updateSmoothing(
        current ->
