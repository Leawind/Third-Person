...
public class YaclConfigScreenBuilder extends ConfigScreenBuilder {
   ...
   *
   * <p>text key: button.${name}.text
   *
   * <p>description key: button.${name}.desc
   *
   * @param name name
  ...
  private Option.Builder<Boolean> booleanOption(
  ...
  private Option.Builder<Integer> option(
      String name,
      int defaultValue,
      int min,
      int max,
  ...
  private Option.Builder<Double> option(
      String name,
      double defaultValue,
      double min,
      double max,
