...
import com.github.leawind.thirdperson.utils.Surroundings;
...
public final class Constants {
  ...
  public static final String KEY_CATEGORY = "key.categories." + ThirdPerson.MOD_ID;

  public static final String CONFIG_FILE_PATH = "config/" + ThirdPerson.MOD_ID + ".json";
