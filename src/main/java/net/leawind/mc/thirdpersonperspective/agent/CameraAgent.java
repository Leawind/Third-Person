			...
			if (Config.auto_switch_camera_offset_type && !cameraOffsetType.isTop()) {
				...
				*/
				...
				if (surroundingBlocks.match(new Boolean[]{true, false, true, null, null, null, null, null, null,}) ||
					surroundingBlocks.match(new Boolean[]{null, false, null, true, null, true, null, null, null,})) {
					cameraOffsetType = cameraOffsetType.toTop();
						   ...
						   surroundingBlocks.match(new Boolean[]{null, null, false, true, null, false, null, null, false,})) {
					cameraOffsetType = cameraOffsetType.toRight();
						   ...
						   surroundingBlocks.match(new Boolean[]{false, null, null, false, null, true, false, null, null,})) {
