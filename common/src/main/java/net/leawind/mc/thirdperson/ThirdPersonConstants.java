...
public final class ThirdPersonConstants {
	...
	@VersionSensitive public static final List<String> BUILDIN_AIM_ITEM_RULES        = List.of("crossbow{Charged:1b}", "ender_pearl", "snowball", "egg", "splash_potion", "lingering_potion", "experience_bottle");
	@VersionSensitive public static final List<String> BUILDIN_USE_AIM_ITEM_RULES    = List.of("bow", "trident");
}
