...
public class ModConstants {
	...
	public static final List<String> BUILDIN_AIM_ITEMS             = List.of("crossbow{Charged:1b}", "ender_pearl", "snowball", "egg", "splash_potion", "lingering_potion", "experience_bottle");
	public static final List<String> BUILDIN_USE_AIM_ITEMS         = List.of("bow", "trident");
}
