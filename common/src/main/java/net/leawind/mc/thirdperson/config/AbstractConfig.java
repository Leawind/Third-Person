...
public class AbstractConfig {
	...
	@Expose public List<String> aim_item_rules;
	@Expose public List<String> use_aim_item_rules;
	...
	public void setToDefault () {
		...
		//---------------------------------------
		enable_buildin_aim_item_rules = true;
		aim_item_rules                = new ArrayList<>();
		use_aim_item_rules            = new ArrayList<>();
	}
}
