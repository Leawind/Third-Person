...
- **Smart Aim Mode** Automatically switches to aim mode based on the item the player is holding and its using status. Rules can be customized. So it can be compatible with items from other mods. Here is [Documentation](https://leawind.github.io/Third-Person/en_us/Details/ItemPredicate)
